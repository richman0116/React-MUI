...
const Invoices = ({ register, setValue, watch, load, control, errors, index }) => {
	console.log(Boolean(errors.lastDate));
	return (
		<div className={styles.pdfArea} style={{ marginBottom: "30px" }}>
					...
					<Grid item sm={6}>
						<p>
							...
							<div className={styles.inlineLabelInput}>
								...
								<TextField
									{...register(`load_reference_${index}`)}
									id="small-input"
									variant="outlined"
									size="small"
									className={styles.customInput}
				...
				<div className="customerInformation mt-4">
					...
					<Grid style={{ marginTop: "2px" }} container columnSpacing={2} rowSpacing={1}>
						<Grid item sm={6}>
							...
							/>
							<TextField
								{...register(`company_address_${index}`)}
								id="small-input"
								variant="outlined"
								size="small"
								className={styles.customInput}
						...
						<Grid item sm={6}>
							<div className={styles.inlineLabelInput}>
								...
								<TextField
									{...register(`billing_primary_contact_${index}`)}
									id="small-input"
									variant="outlined"
									size="small"
									className={styles.customInput}
							...
							<div className={styles.inlineLabelInput}>
								...
								<TextField
									{...register(`billing_primary_phone_${index}`)}
									id="small-input"
									variant="outlined"
									size="small"
									className={styles.customInput}
							...
							<div className={styles.inlineLabelInput}>
								...
								<TextField
									{...register(`billing_primary_fax_${index}`)}
									id="small-input"
									variant="outlined"
									size="small"
									className={styles.customInput}
						...
						<tbody>
							<tr className={styles.row}>
								<td className={styles.cell}>
									{" "}
									<TextField
										{...register(`paytm_description_${index}`)}
										id="small-input"
										variant="outlined"
										size="small"
										className={styles.customInput}
								...
								<td className={styles.cell}>
									<div className={styles.inlineLabelInput}>
										<TextField
											{...register(`paytm_quantity_${index}`)}
											id="small-input"
											variant="outlined"
											size="small"
											className={styles.customInput}
